...
"<h2>Title</h2>\n    <div class=\"sa-icon text-icon\"></div>\n    <fieldset>      <input type=\"text\" tabIndex=\"0\" />      <div class=\"sa-input-error\"></div>    </fieldset>" +
...
var setParameters = function setParameters(params) {
  ...
  if (params.imageUrl) {
    ...
    var $customIconForText = modal.querySelector('.sa-icon.text-icon');
    //$customIcon.style.backgroundImage = 'url(' + params.imageUrl + ')';
    //_hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.show($customIcon);
    
    $customIconForText.style.backgroundImage = 'url(' + params.imageUrl + ')';
    _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.show($customIconForText);
    ...
    $customIconForText.setAttribute('style', $customIconForText.getAttribute('style') + 'width:' + _imgWidth + 'px; height:' + _imgHeight + 'px');
  }
