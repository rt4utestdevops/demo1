;(function($, window, document, undefined) {
	...
	var defaults = {
		...
		template: 	'<div class="c-month-view">'+
					...
					'<div class="c-holder">'+
						...
						'<div class="c-specific">'+
							'<div class="specific-day">click here to Back'+
		...
		dayHuman: [["SUN","Sunday"],["MON","Monday"],["TUE","Tuesday"],["WED","Wednesday"],["THU","Thursday"],["FRI","Friday"],["SAT","Saturday"]],
		...
		for(var i=0;i<events.length;i++) {
			...
			if(!!ev.color) {
				...
				if(!!c) {
					...
					ev_p = !!c.text ? 'style="color:'+c.text+';opacity:1.5"' : "";
					ev_a = !!c.link ? 'style="color:'+c.link+'"' : "";
					ev_b = !!c.background ? 'style="height: 104px;background-color:'+c.background+'"' : "";
				}
			}
