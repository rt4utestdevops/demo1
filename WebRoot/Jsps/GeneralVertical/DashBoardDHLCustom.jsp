					...
					<div class="row" style="margin-top: 14px;margin-bottom: 4px;">						
						...
						<div class="col-md-6" style="margin-left : 744px;">
							<div class="col-md-12">								
								...
								<div class="col-md-12" style="margin-left: 21%;">  <!--margin-left: 66px;-->
									<div class="col-md-5"><!-- style="margin-right: -16%">  -->
            ...
            <div class="">
		     ...
		     <div id="onTripVehicleStoppageAlert" class="modal-content modal fade" style="margin-top:1%;margin-left:-5%;width:50%">
						...
						<table id="vehicleStoppageAlert" class="table table-striped table-bordered" cellspacing="0" style="width:-1px;">
                                    <tbody>
                                    	<tr><td>Customer Name</td><td><div id="customerName"></div></td></tr>
                                    	<tr><td>Trip Id</td><td><div id="tripId"></div></td></tr>
                                    	<tr><td>Vehicle Number</td><td><div id="assetNumber"></div></td></tr>
                                    	<tr><td>Trip No</td><td><div id="lrNumber"></div></td></tr>
                                    	<tr><td>Route Name</td><td><div id="routeName"></div></td></tr>
                                    	<tr><td>Current Latitude</td><td><div id="latitude"></div></td></tr>
                                    	<tr><td>Current Longitude</td><td><div id="longitude"></div></td></tr>
                                    	<tr><td>Location</td><td><div id="location"></div></td></tr>
                                    	<tr><td>Total Stop Time(HH:mm:ss)</td><td><div id="duration"></div></td></tr>
										<tr><td>Stop Begin</td><td><div id="stoppageBegin"></div></td></tr>
                                    </tbody>
                             </table>
                        </div>
                        <div class="modal-footer" style="text-align: center; height:52px;">
 		    	...
 		    	<div id="onTripVehicleStoppageDetails" class="modal-content modal fade" style="margin-top:1%">
                    ...
                    <div id="onTripVehiclStoppageMapModal" class="modal-content modal fade" style="margin-top:1%">
	                    ...
	                    <div class="modal-footer" style="text-align: right; height:52px;">
			    			...
			    			<button class="btn btn-primary" id="updateLandMarkBtnId" onclick="updateLandMark()">SAVE & MARK AS DONE</button>
	                        <button type="reset" class="btn btn-danger" data-dismiss="modal">Close</button>
	                    </div>
                    </div>
					 ...
					 //call notification 2 
                            ...
                            $('input[type=checkbox]').on('change', function() { if(!this.checked){ console.log('unchecked checkbox'); } });
                                ...
                                $('#dateInput2 ').jqxDateTimeInput('setDate', new Date());																	
									...
									$("#startDateInput").jqxDateTimeInput({ theme: "arctic", formatString: "dd/MM/yyyy", showTimeButton: false, width: '120px', height: '25px'});
									$('#startDateInput ').jqxDateTimeInput('setDate', '');
								    $("#atpDateInput").jqxDateTimeInput({ theme: "arctic", formatString: "MM/dd/yyyy HH:mm", showTimeButton: true, width: '197px', height: '25px'});
									$('#atpDateInput').jqxDateTimeInput('setDate', '');
									$("#atdDateInput").jqxDateTimeInput({ theme: "arctic", formatString: "MM/dd/yyyy HH:mm", showTimeButton: true, width: '197px', height: '25px'});
									$('#atdDateInput').jqxDateTimeInput('setDate', '');

									$("#endDateInput").jqxDateTimeInput({ theme: "arctic", formatString: "dd/MM/yyyy", showTimeButton: false, width: '120px', height: '25px'});
								...
								$("#updtateATADate").jqxDateTimeInput({ theme: "arctic", formatString: "dd/MM/yyyy HH:mm:ss", showTimeButton: true, width: '197px', height: '25px'});
                           ...
                           function plotSingleVehicle(vehicleNo, latitude, longtitude, location, gmt, tripStatus, custName, shipmentId, delay1, weather, driverName, etaDest, etaNextPt,routeId,ATD,
		 	       		...
		 	       		// 	if(productLine != 'Dry')
		        			{
								...
								// changing date format to dd/mm/yyy
								...
								*/
                                ...
                                google.maps.event.addListener(marker, 'dblclick', (function(marker, parameterStr) {
                                    return function() {
                                        ...
                                        window.open("<%=request.getContextPath()%>/Jsps/GeneralVertical/TripAndAlertDetailsCustom.jsp?" + parameterStr, '_blank');
                                    };
                                })(marker, parameterStr));
    ...
    "time-uni-desc": function (a, b) {
        return ((a < b) ? 1 : ((a > b) ? -1 : 0));
                 ...
                 },
                 {
								...
								/*
								$("div.toolbar").html('<form  id="toggle-form">'+
									'<input type="radio" name="abc" value="0" class="radio1" id="0" onchange="checkRadioButton(this.id)" style="margin-left:-155px" > On-Trip'+
                    				'<input type="radio" name="abc" value="2" class="radio1" id="2" onchange="checkRadioButton(this.id)" style="margin-left:40px"> 1 Week' +
                    				'<input type="radio" name="abc" value="4" class="radio1" id="4"  onchange="checkRadioButton(this.id)" style="margin-left:40px"> 1 Month' +
                    				'<input type="radio" name="abc" value="5" class="radio1" id="5" onchange="showCategory()" style="margin-left:40px"> Date Range</br>'+
                    				' <label for="staticEmail2" style="font-weight: normal;margin-left: -194px;margin-bottom : 2px">Start Date</label>'+
									//'<div class="input-group date" style="margin-top: -186px">'+
									'<input type="text"  id="startDateInput" style="margin-left:14px"/></div>' +
									' <label for="staticEmail1" style="font-weight: normal;margin-left: 12px;margin-bottom : 2px">End Date</label>'+
									//'<div class="input-group date" style="margin-top: -23px">'+
									'<input type="text"  id="endDateInput" style="margin-left:14px"/></div></form>' );  */
						    ...
						    if(hasTripCreatePermission){
                                //showAlertOnTripVehicleStoppage();
           ...
           //"scrollY": "280px",
             ...
             tripATPdelayTable.columns( [1,9,10,11,12,13,14] ).visible( false );
				...
				function showTripDelayInSourceReachMap(data)
				{
							...
							var pos = new google.maps.LatLng(data[10], data[11]);
				 			var mapOptions = {
                                    zoom: 15,
                                    center: pos,
                                    mapTypeId: google.maps.MapTypeId.ROADMAP,
							...
							mapView = new google.maps.Map(document.getElementById('dvMap1'), mapOptions);
							...
							vehiclemarker = new google.maps.Marker({
								...
								vehiclemarker.setMap(mapView);
								var contentForDot = '<div id="myInfoDivForVehicle" seamless="seamless" scrolling="no" style="overflow:hidden; width:100%; height: 100%; float: left; color: #000; background:#ffffff; line-height:100%; font-size:11px; font-family: sans-serif;">' +
								'<table>' +
							...
							google.maps.event.addListener(vehiclemarker, 'click', function() {
								...
								infowindowDot.open(mapView, vehiclemarker);
...
<!--                                       if($('#cust_names').hasClass("select2-hidden-accessible")){-->
<!--			                            $('#cust_names').select2('destroy');-->
<!--			                            $('#cust_names').prop("multiple", "multiple");}-->
                       ...
                       function getTripCustomerType() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        console.log("custTypeList  " + custTypeList);
            for (var i = 0; i < custTypeList["tripCustTypeRoot"].length; i++) {
                $('#cust_type').append($("<option></option>").attr("value", custTypeList["tripCustTypeRoot"][i].tripCustomerValue).
				text(custTypeList["tripCustTypeRoot"][i].tripCustomerType));
            }
     ...
     $('#delayId').val(delay);
                            ...
                            document.getElementById("page-loader").style.display="block";
                                $.ajax({
                                    ...
                                    //alert('response occurred :'+responseText );
                                ...
                                $.ajax({
                                    ...
                                    success: function(result) {
                                        ...
                                        for (var i = 0; i < results['columnSettingsRoot'].length; i++) {
                                            ...
                                            //else{ //Check why this is not working
                                            //alert(results['columnSettingsRoot'][i].columnName +':name');
                                            //	table.column(results['columnSettingsRoot'][i].columnName +':name').visible(true);
                                            //}
                                        }
                                    }
                                });
							...
							$('#smartHub').prop("checked",false).trigger("change");
							 var pos = new google.maps.LatLng(onTripVehStopLatitude, onTripVehStopLongitude);
				 			var mapOptions = {
                                    zoom: 15,
                                    center: pos,
                                    mapTypeId: google.maps.MapTypeId.ROADMAP,
				...
				mapView = new google.maps.Map(document.getElementById('dvMap'), mapOptions);
				imageurl = '/ApplicationImages/VehicleImagesNew/MapImages/default_BR.png';
				image = {
					url: String(imageurl), // This marker is 20 pixels wide by 32 pixels tall.
					scaledSize: new google.maps.Size(35, 35), // The origin for this image is 0,0.
                 ...
                 $('#showSmartHub').change(function() {
	                if (this.checked) {
			            ...
			            for (var i = 0; i < circlessmart1.length; i++) {
			                circlessmart1[i].setMap(null);
			                buffermarkersmart1[i].setMap(null);
			            }
			            for (var i = 0; i < polygonsmart1.length; i++) {
			                polygonsmart1[i].setMap(null);
			                polygonmarkersmart1[i].setMap(null);
			            }
			        }
				});
		...
		function plotBuffersForSmartHubTd()
		{
		  ...
		  bufferimage1 = {
		   ...
		   buffermarker1 = new google.maps.Marker({
	            	position: myLatLng1,
	            	id:rec.data['vehicleNo'],
	            	map: mapView,
	            	icon:bufferimage1
	        	});
	        buffercontent1=rec.data['buffername']; 	
			bufferinfowindow1 = new google.maps.InfoWindow({
	      		content:buffercontent1,
	      		id:rec.data['vehicleNo'],
	      		marker:buffermarker1
	  		});	
	  		google.maps.event.addListener(buffermarker1,'click', (function(buffermarker1,buffercontent1,bufferinfowindow1){ 
	    			return function() {
	        			bufferinfowindow1.setContent(buffercontent1);
	        			bufferinfowindow1.open(map,buffermarker1);
	    			};
				})(buffermarker1,buffercontent1,bufferinfowindow1)); 
				buffermarker1.setAnimation(google.maps.Animation.DROP); 

	    		buffermarkersmart1[i]=buffermarker1;
				circlessmart1[i] = new google.maps.Circle(createCircle1);
		    }
	    }
	...
	function plotPolygonSmartHubTd(){
	    ...
	    for(var i=0;i<polygonStoreSmartHubTripDelay.getCount();i++)
	    {
  			...
  			polygonCoords=[];
				 ...
				 $.ajax({
				       ...
				       $.ajax({
        	                            ...
        	                            "dataSrc": "columnSettingsRoot",
                	                    success: function(result) {
						               //update status closed in ON_TRIP_VEHICLE_STOPPAGE_ACTION
		 ...
		 function loadTripDetails(obj){
			       if(<%=isAdmin%>){
						// $('#updateATAforClosedTrips').modal('hide');
         ...
         function updateATA() {
            ...
            var inRange = false;
            if (ataD > startD && ataD < endD){inRange = true;}
         	if (inRange){ 
	         	$.ajax({
