                          ...
                          <div class="row" style="height:100%;">
                             <div class="col-lg-12">
                                 ...
                                 <div class="row alignPad">
                                   <div class="col-lg-3">
                                     Sold & Dispatched<br/>
                                     <span id="totalAmount" onclick="OpenDataTable('1','Sold & Dispatched')">0</span>
                                   </div>
                                   <div class="col-lg-3">
                                     Royalty Collected<br/>
                                     <span id="onlineRoyalty" onclick="OpenDataTable('1','Royalty Collected')">0</span>
                                   </div>
                                   <div class="col-lg-3 lightGrey">
                                     GST<br/>
                                      <span id="onlineGST" onclick="OpenDataTable('1','GST')">0</span>
                                   </div>
                                   <div class="col-lg-3 lightGrey">
                                     Booked & Open<br/>
                                      <span id="onlineBooked" onclick="OpenDataTable('1','Booked & Open')">0</span>
                                   </div>
                                 </div>
                             </div>
                           </div>
                            ...
                            <div class="row" style="height:100%;">
                               <div class="col-lg-12">
                                   ...
                                   <div class="row alignPad">
                                     <div class="col-lg-3">
                                       Total Available<br/>
                                       <span id="sandStockTotal" onclick="OpenDataTable('2','Total Available')">0</span>
                                     </div>
                                     <div class="col-lg-3 lightGrey">
                                       Booked Qty.<br/>
                                       <span id="sandStockBooked" onclick="OpenDataTable('2','Booked Qty')">0</span>
                                     </div>
                                     <div class="col-lg-3">
                                       Available For Booking<br/>
                                       <span id="sandStockAvailable" onclick="OpenDataTable('2','Available for booking')">0</span>
                                     </div>
                                     <div class="col-lg-3 lightGrey">
                                       Dispatched Qty.<br/>
                                       <span id="sandStockDispatched" onclick="OpenDataTable('2','Dispatched Quantity')">0</span>
                                     </div>
                                   </div>
                               </div>
                             </div>
                              ...
                              <div class="row" style="height:100%;">
                                 <div class="col-lg-12">
                                     ...
                                     <div class="row alignPad">
                                       <div class="col-lg-3">
                                         Total<br/>
                                         <span id="totalVehicle" onclick="OpenDataTable('3','Total')">0</span>
                                       </div>
                                       <div class="col-lg-3 lightGrey">
                                         Non-Communicating<br/>
                                        <span id="nonCommunicating" onclick="OpenDataTable('3','Non-Cmmunicating')">0</span>
                                       </div>
                                       <div class="col-lg-3">
                                         Communicating<br/>
                                        <span id="communicating" onclick="OpenDataTable('3','Communicating')">0</span>
                                       </div>
                                       <div class="col-lg-3 lightGrey">
                                         On-Trip<br/>
                                         <span id="onTrip" onclick="OpenDataTable('3','On Trip')">0</span>
                                       </div>
                                     </div>
                                 </div>
                               </div>
                                ...
                                <div class="row" style="height:100%;">
                                   <div class="col-lg-12">
                                       ...
                                       <div class="row alignPad">
                                         <div class="col-lg-3">
                                           Total<br/>
                                           <span id="tripTotal" onclick="OpenDataTable('4','Total')">0</span>
                                         </div>
                                         <div class="col-lg-3 lightGrey">
                                           Deviation<br/>
                                           0
                                  ...
                                  <div class="row" style="height:100%;">
                                     <div class="col-lg-12">
                                         ...
                                         <div class="row alignPad">
                                           <div class="col-lg-3">
                                             Entry Tokens<br/>
                                             <span id="tokens" onclick="OpenDataTable('5','Entry Tokens')">0</span>
                                           </div>
                                           <div class="col-lg-3 lightGrey">
                                             Delivery Challans<br/>
                                            <span id="delivery" onclick="OpenDataTable('5','Delivery Challans')">0</span>
                                           </div>
                                           <div class="col-lg-3">
                                             Loading Vehicles<br/>
                                             <span id="loadingVehicles" onclick="OpenDataTable('5','Loading Vehicles')">0</span>
                                           </div>
                                           <div class="col-lg-3 lightGrey">
                                             Reprints<br/>
                                             <span id="reprints" onclick="OpenDataTable('5','Reprints')">0</span>
                                           </div>
                                         </div>
                                     </div>
                                   </div>
              ...
              result=result.stockyardInfo;
                for (var i = 0; i < result.length; i++) {
                 //   $('#select-menu').append($("<option></option>").attr("value", result[i].id).text(result[i].Name).attr("available", result[i].availableSandQuantity).attr("latitude", result[i].latitude).attr("longitude", result[i].longitude));
                    ...
                    var pos = new google.maps.LatLng(result[i].Latitude,result[i].Longitude);
                    var marker = new google.maps.Marker({
                        position: pos
                     });
                     marker.setMap(map)
                     markerClusterArray.push(marker);
                     var content = '<div id="myInfoDiv" class="blueGreyLight" seamless="seamless" scrolling="no" style="border: 1px solid #37474F;overflow:hidden; width:100%; height: 100%; float: left; color: #000; line-height:100%; font-size:11px; font-family: sans-serif;padding:8px;">' +
                         '<table class="infoDiv">' +
					...
					//	console.log(result[i].stockyardName+"   "+result[i].districtDetails.districtName+"   "+ result[i].availableSandQuantity);
						let infowindow = new google.maps.InfoWindow({
	                         ...
	                         stockyardName:result[i].Name,
	                         availableStock: result[i].availableSandQuantity,
	                        // unitPrice : result[i].sandQualities[0].rate
                      ...
                      google.maps.event.addListener(marker, 'click', (function(marker, contents, infowindow) {
                         return function() {
                            ...
                            $("#districtDropDownId option").each(function() {
							  if($(this).text() == infowindow.districtName) {
							               $("#districtDropDownId").val($(this).val()).trigger('change');
							  }                        
							});
                             stockyardIdGlobal = infowindow.id;
                             // $("#stockyardDropDownId option").each(function() {
                             // console.log($(this).text());
							 //   if($(this).text() == infowindow.stockyardName) {
							 	   $("#stockyardDropDownId").val(infowindow.id).trigger('change');
							  //}                       
							//});
                          // $("#stockyardDropDownId").html(infowindow.AvailableSandQuantity).trigger('change');
                       //      $("#unitPrice").html(infowindow.unitPrice);
                             //unitPrice = infowindow.unitPrice;
...
function getVehicleReportDetails()
{
    ...
    // setTimeout(function(){ 
         ...
         "ajax": {
               url: '<%=request.getContextPath()%>/JSMDCDashboardAction.do?param=getVehicleReportDetails&stockyardId='+stockyardId,
             "data": {
                // startDate: startDate,
				// endDate: endDate
             },
