...
<title>Zero Value Coordinates Report</title>
<meta charset="utf-8">
...
<nav class="navbar navbar-default" style="background-color: darkcyan;">
<div class="container-fluid">
	<div class="navbar-header">
		<a class="navbar-brand" href="#" style="color: white;">Zero Value Coordinates Report</a>
	</div>
</div>
</nav>
  ...
  function getData(){
    if ($.fn.DataTable.isDataTable('#example')) {
     ...
     table = $('#example').DataTable({
         "ajax": {
             "url": '<%=request.getContextPath()%>/SandExcavationReportAction.do?param=getZeroValueCooordinatesDetails',
             "data": {
             },
             "dataSrc": "zeroValueCooordinatesDetails"
         },
          "bDestroy": true,
		        "oLanguage": {
