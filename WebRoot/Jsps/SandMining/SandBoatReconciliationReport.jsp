...
<jsp:include page="../Common/header.jsp" />
	<title> Sand Boat Reconciliation Report</title>
	<meta charset="utf-8">
...
<nav class="navbar navbar-default" style="background-color: #00a7cd;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#" style="color: black">Sand Boat Reconciliation Report</a>
    </div>
  </div>
</nav>
	...
	<div class="row">
		...
		<div class="panel-body" style="overflow-y: auto;">
			<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
           		<thead>
                 	<tr>
					<th rowspan='2' class="text-center" style="vertical-align: middle">Serial Number</th>
					<th colspan='2' class="text-center" >Input from MDP generation</th>
					<th colspan='2' class="text-center">Input from boat activity</th>
					</tr>
					<tr>
					<th class="text-center">Number of MDPs generated</th>
					<th class="text-center">Quantity of sand as per MDP generated (Tons)</th>
					<th class="text-center">Number of Authorized trips by boats</th>
					<th class="text-center">Quantity of sand excavated based on number of trips (Tons)</th>
...
function getTpOwner(el){
	...
	$.ajax({
        url: '<%=request.getContextPath()%>/SandBoatReconciliationReportAction.do?param=getTPownerName',
         data: param,
          success: function(result) {
  ...
  function getData(){
    ...
    if(tpName == ''){
     ...
     table = $('#example').DataTable({
         ...
         // "serverSide": true,
         "ajax": {
             "url": '<%=request.getContextPath()%>/SandBoatReconciliationReportAction.do?param=getSandBoatReconciliationReport',
         ...
         "columns": [{
             ...
             "data": "numberOfMDPIndex"
         },{
         	"data": "quantityAsPerMDPIndex"
         }, {
             "data": "numberOfTripsIndex"
         }, {
             "data": "quantityAsPerNoOfTripsIndex"
         }]
     });
    }
    }
