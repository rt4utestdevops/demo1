...
<%
	...
	String SandInwardReport="Subscription Validity Report";//convertedWords.get(11);
  ...
  <head>
    ...
    <body height="100%"">
       <%if (loginInfo.getStyleSheetOverride().equals("Y")){%>
        ...
        <script>
            var jspName = 'VehicleSubscriptionRenwal';
            var dtcur = new Date();
       		var dtprev = dtcur;
        ...
        //********************************* Reader Config***********************************
            ...
            var store = new Ext.data.GroupingStore({
                ...
                proxy: new Ext.data.HttpProxy({
                    url: '<%=request.getContextPath()%>/VehicleSubscriptionAction.do?param=getSubscriptionVehicleReportDetails',
                    method: 'POST'
                }),
                remoteSort: false,
                storeId: 'gridStore',
                ...
                var columns = [
                    new Ext.grid.RowNumberer({
                       ...
                       filter: {
			            ...
			            header: "<span style=font-weight:bold;>Payment Due Date Reminder</span>",
			            dataIndex: 'remainderDateindex',
			            width: 100,
			            filter: {
			                type: 'date'
