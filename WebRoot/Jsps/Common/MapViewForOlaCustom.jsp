...
<html>
  ...
  <head>
    ...
    <body background-color="white" oncontextmenu="return false;">
	 <div class="container">
		 <div class = "main">
				...
				<div class="mp-container" id="mp-container">
					...
					<table width="98%">
						...
						<td>
            				...
            				<td width="25%"><div class ="checkBoxRegion"  style="display:none;">
...
function createPolylineTrace(){
	...
	function plotSingleVehicle(vehicleNo, latitude, longtitude, location, gmt, status, imagePath) {
		if (status == 'stoppage') {
		...
		if (cb.checked) {
			...
			for (var k = 0; k < store.getCount(); k++) {
				...
				if (!recnew.data['latitude'] == 0 && !recnew.data['longitude'] == 0) {
					countAll++;
					plotSingleVehicle(recnew.data['vehicleNo'], recnew.data['latitude'], recnew.data['longitude'], recnew.data['location'], recnew.data['gmt'], recnew.data['category'], recnew.data['imagePath']);
				}
			}
