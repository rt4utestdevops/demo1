...
//********************************** AssetDetails,Buffer & Polygon Store *********************************************	    
		...
		var mapViewAssetDetails = new Ext.data.JsonStore({
				...
				autoLoad: false,
				remoteSort: true,
				fields: ['vehicleType','model','ownerName','status','cashin','cashout','cashbalance','vehicleNo','gmt','location','ignition','drivername','groupname','ownerNumber','drivermobile','speed','temperature', 'LRNO', 'tripNo', 'routeName']
		});
...
function historyAnalysis(vehicleNo){
	...
	var url="<%=request.getContextPath()%>/Jsps/Common/HistoryAnalysisOpenLayer.jsp?vehicleNo="+vehicleNo+"&hisTrackNew="+hisTrackNew+"&mapType="+mapTypeFromOpen;
