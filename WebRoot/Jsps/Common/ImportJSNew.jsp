...
<pack:style src="../../Main/resources/css/T4Ucommon.css" />
<pack:style src="../../Main/resources/css/dashboard.css" />
<pack:style src="../../Main/resources/css/T4UTheme.css" />
...
//ga('send', 'pageview');
  ...
  <table style="width:100%;height:99%;background-color:#DFE8F6;margin-top: 0;overflow:hidden" align="center">
