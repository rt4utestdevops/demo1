...
<script>
	...
	var outerPanel;
	var AssetNo;
 	var jspName='Order_Details_Report';
   	var exportDataType = "int,string,date,string,string,number,number,number,number,number";
    var dtprev = dateprev;
	var dtcur = datecur;
	var dtnxt = datenext;
	var reportTypeId;
...
//************************ Combo for Customer Starts Here***************************************//
	...
	var reportTypeStore =  new Ext.data.SimpleStore({
	  							 ...
	  							 data: [['1', 'Weigh Bridge Report'],['2', 'Duplicate Transit Permit'], ['3', 'Invalid Transit Permit']]
							}); 
	...
	var reader = new Ext.data.JsonReader({
        ...
        fields: [{
            ...
            name: 'orderDateDataIndex'
        },{
            name: 'customerNameDataIndex'
        },{
            name: 'VehicleNoDataIndex'
        },{
            name: 'orderQtyDataIndex'
        },{
            name: 'soldQtyDataIndex'
        },{
        	name: 'remainingQtyDataIndex'
        },{
            name: 'weightQtyDataIndex'
        },{
        	name: 'excessQtyDataIndex'
        }]
    });
    ...
    var SummaryReportStore = new Ext.data.GroupingStore({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '<%=request.getContextPath()%>/SandTSMDCAction.do?param=getOrderDetailsReport',
            method: 'POST'
        }),
        remoteSort: false,
    ...
    var filters = new Ext.ux.grid.GridFilters({
        ...
        filters: [{
            ...
            type: 'numeric',
            dataIndex: 'orderQtyDataIndex'
        }, {
            type: 'numeric',
            dataIndex: 'soldQtyDataIndex'
        }, {
            type: 'numeric',
            dataIndex: 'remainingQtyDataIndex'
        }, {
            type: 'numeric',
            dataIndex: 'weightQtyDataIndex'
        },{
            type: 'numeric',
            dataIndex: 'excessQtyDataIndex'
        }]
    });
    ...
    var createColModel = function (finish, start) {
        ...
        var columns = [
            new Ext.grid.RowNumberer({
                ...
                header: "<span style=font-weight:bold;>Ordered Quantity (Cu M)</span>",
                dataIndex: 'orderQtyDataIndex',
                filter: {
                    type: 'numeric'
                }
            }, {
                header: "<span style=font-weight:bold;>Sold Quantity (Cu M)</span>",
                dataIndex: 'soldQtyDataIndex',
                filter: {
                    type: 'numeric'
                }
            }, {
                header: "<span style=font-weight:bold;>Remaining Quantity (Cu M)</span>",
                dataIndex: 'remainingQtyDataIndex',
                filter: {
                    type: 'numeric'
                }
            },{
                header: "<span style=font-weight:bold;>Weigh Bridge Sold Quantity (Cu M)</span>",
                dataIndex: 'weightQtyDataIndex',
                filter: {
                    type: 'numeric'
                }
            },{
                header: "<span style=font-weight:bold;>Excess Quantity (Cu M)</span>",
                dataIndex: 'excessQtyDataIndex',
                filter: {
                    type: 'numeric'
                }
