...
padding-bottom:10px;
        ...
        var jspName='SandTripSummaryReport';
    ...
    // **********************************************Reader configs Starts******************************
     ...
     var reader = new Ext.data.JsonReader({
    	...
    	name: 'SourceLatLongId'
    	}, {
    	name: 'DestinationId'
    	},{
    	name: 'DestinationLatLongId'
    	},{
        name: 'DistanceTravlledId'
    	},{
        name: 'TripCountId'
    	},{
        name: 'TotalDistanceTravlledId'
    	},{
        name: 'TotalTripCountId'
    	}]
    });
    // Sand Trip Summary Report
    // **********************************************Reader configs Ends******************************
    ...
    var store = new Ext.data.GroupingStore({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '<%=request.getContextPath()%>/HubSummaryReportAction.do?param=getSandTripSummaryDetailsNew',
            method: 'POST'
        }),
        remoteSort: false,
   ...
   //********************************************Store Configs For Grid Ends*************************
    ...
    url: '<%=request.getContextPath()%>/HubSummaryReportAction.do?param=getHubsCWT',
    id: 'HubStoreId',
    root: 'AllHubRootsNew',
    autoLoad: false,
    fields: ['hubName','hubId']
		...
		checkField:'checked',
          ...
          select:function(record, index) {     
            //  alert("Hub Id  " + Ext.getCmp('HubcomboId').getRawValue());
    ...
    //********************************************************************Filter Config***************
    	...
    	type: 'string',
        dataIndex: 'SourceLatLongId'
    	}, {
        type: 'string',
        dataIndex: 'DestinationId'
    	}, {
    	type: 'string',
        dataIndex: 'DestinationLatLongId'
    	}, {
        type: 'string',
        dataIndex: 'DistanceTravlledId'
    	}, {
        type: 'string',
        dataIndex: 'TripCountId'
    	}, {
        type: 'string',
        dataIndex: 'TotalDistanceTravlledId'
    	}, {
        type: 'string',
        dataIndex: 'TotalTripCountId'
    	}]
    	});
    ...
    var createColModel = function (finish, start) {
        var columns = [
        	...
        	dataIndex: 'OwnerId',
        	header: "<span style=font-weight:bold;>Owner Info</span>",
        	// renderer: Ext.util.Format.dateRenderer('d-m-Y'),
        	width: 100,        	
        	filter: {
            type: 'String'
        	...
        	header: "<span style=font-weight:bold;>Source Lat Long</span>",
        	dataIndex: 'SourceLatLongId',
        	width: 110,
        	filter: {
            type: 'string'
        	...
        	header: "<span style=font-weight:bold;>Destination Lat Long</span>",
        	dataIndex: 'DestinationLatLongId',
        	width: 110,
        	filter: {
            type: 'string'
        	...
        	header: "<span style=font-weight:bold;>Distance Travlled</span>",
        	dataIndex: 'DistanceTravlledId',
        	width: 110,
        	filter: {
            type: 'string'
        	...
        	header: "<span style=font-weight:bold;>Trip Count</span>",
        	dataIndex: 'TripCountId',
        	width: 110,
        	//hidden:true,
        	hideable:false,
        	...
        	header: "<span style=font-weight:bold;>Total Dist Travlled</span>",
        	dataIndex: 'TotalDistanceTravlledId',
        	width: 110,
        	//hidden:true,
        	hideable:false,
        	...
        	header: "<span style=font-weight:bold;>Total Trip Count</span>",
        	dataIndex: 'TotalTripCountId',
        	width: 110,
        	//hidden:true,
        	hideable:false,
    ...
    grid = getGrid('Trip Summary Report', 'No Records Found', store, screen.width - 45, 385, 16, filters, 'Clear Filter Data', false, '', 14, false, '', false, '', true, 'Excel', jspName, exportDataType, true, 'PDF');	
        ...
        // ***********************   Pannel For Customer For Adding Trip Inforamtion**************************		
             ...
             layout: 'table',                 
               ...
               startDateField: 'startdate'
				...
				var customerPanelNew = new Ext.Panel({
   			 standardSubmit: true,
             collapsible: false,
             border: false,
             frame: false,
             ...
             layout: 'table',                 
               ...
               startDateField: 'startdate'
                ...
                if (Ext.getCmp('GrpcomboId').getValue() == "") {
                	Ext.example.msg('Please Select the Group');                   
                    return;
                }
                
                if (Ext.getCmp('RegcomboId').getValue() == "") {
                	Ext.example.msg('Please Select the Registration no');                   
                    return;
                }
