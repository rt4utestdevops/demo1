...
<jsp:include page="../Common/header.jsp" />
    ...
    <style type="text/css">
        ...
        .label#alertdetailsctbid1 {
        	display: none !important;
        	        margin-bottom: -3.5rem;
        }
        .div#totalAssetHeader {
...
//******************************store for getting customer name************************
        ...
        function callAlertFunction(alertname) {
            if (alertname == 'REFUEL_LITERS') {
                ...
                setInterval(function() {fuelconsumptionalert();
                }, 60000); // 1min refresh
            } else if (alertname == 'VEHICLE_ON_OFF_ROAD') {
                vehicleOnOffAlert();
                setInterval(function() {vehicleOnOffAlert();
                }, 60000); // 1min refresh
...
/*************************************** Panel for VEHICLE OFF ROAD ******************************************************/
        ...
        var VEHICLE_OFF_ROAD = new Ext.Panel({
            ...
            items: [{
                ...
                border: false,
                items: [{
                    html: '<div class="vehicleOffRoadDeatilsNavimage" id="vehicleOffdetailsnav" onclick="getVehicleOffRoadDetails(6);"></div>',
                    xtype: 'panel',	
                    bodyCssClass: 'htmltotaldetailsnav',
            ...
            statutoryStore.load({
                ...
                callback: function() {
                    ...
                    google.visualization.events.addListener(statutorybargraph, 'select', function() {
                        ...
                        switch (id) {
                            case 1:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 10, 'Statutory Details Insurance Due for Expiry');
                                break;
                            case 2:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 32, 'Statutory Details Insurance Expired');
                                break;
                            case 11:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 11, 'Statutory Details Goods Token Tax Due for Expiry');
                                break;
                            case 12:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 33, 'Statutory Details Goods Token Tax Expired');
                                break;
                            case 21:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 12, 'Statutory Details FCI Due for Expiry');
                                break;
                            case 22:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 34, 'Statutory Details FCI Expired');
                                break;
                            case 31:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 13, 'Statutory Details Emission Due for Expiry');
                                break;
                            case 32:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 35, 'Statutory Details Emission Expired');
                                break;
                            case 41:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 15, 'Statutory Details Permit Due for Expiry');
                                break;
                            case 42:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 36, 'Statutory Details Permit Expired');
                                break;
                            case 51:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 130, 'Statutory Details Registration/Revenue Due for Expiry');
                                break;
                            case 52:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 131, 'Statutory Details Registration/Revenue Expired');
                                break;
                            case 61:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 66, 'Statutory Details Driver License Due for Expiry');
                                break;
                            case 62:
                                getDashBoardDetailsStatutoryAlert(cutomerID, 67, 'Statutory Details Driver License Expired');
                                break;
                        }
