...
Ext.EventManager.onWindowResize(function () {
    ...
    masterTab = new Ext.TabPanel({
	    ...
	    {
		case 0:Ext.getCmp('userTabId').update("<iframe style='width:100%;height:525px;border:0;'src='<%=path%>/Jsps/Admin/NewJsp.jsp'></iframe>");break;
		case 1:Ext.getCmp('auditLogTabId').update("<iframe style='width:100%;height:525px;border:0;' src='<%=path%>/Jsps/Admin/AuditLogReport.jsp'></iframe>");break;
		}
    	}		
	},       
    ...
    function addTab(){
     masterTab.add({
         title: 'User Feature Details',
        	iconCls: 'admintab',
        	id:'userTabId',
        	html : "<iframe style='width:100%;height:525px;border:0;'src='<%=path%>/Jsps/Admin/NewJsp.jsp'></iframe>"
     }).show();        
     masterTab.add({
         ...
         autoScroll:true,
         id:'auditLogTabId',
         html : "<iframe style='width:100%;height:525px;border:0;' src='<%=path%>/Jsps/Admin/AuditLogReport.jsp'></iframe>"
     }).show();
    }
