...
.quantityBox1
  ...
  <body>
   ...
   <script>
        ...
        var exportDataType = "int,string,string,string,string,string,string,string,string,string,string,number,number,number,number,string,string";
        var routeName;
        var routeId;
        var tcId;
        var lesseName;
        ...
        //************************ Store for TC LEASE NAME Here***************************************//
        var tcLeaseNameComboStore = new Ext.data.JsonStore({
            url: '<%=request.getContextPath()%>/TripSheetGenerationAction.do?param=getTCNameList',
            id: 'tcNameStoreId',
            root: 'tcLeaseNameRoot',
            autoload: false,
            remoteSort: true,
            fields: ['TCNameID', 'TcLeaseName'],
            listeners: {
                load: function() {}
            }
        });

        var tcNameCombo = new Ext.form.ComboBox({
            store: tcLeaseNameComboStore,
            id: 'tcNamecomboId',
            mode: 'local',
            forceSelection: true,
            resizable: true,
            emptyText: '<%=selectTCLeaseName%>',
            blankText: '<%=selectTCLeaseName%>',
            selectOnFocus: true,
            allowBlank: true,
            anyMatch: true,
            typeAhead: false,
        ...
        var tcNameComboForTare = new Ext.form.ComboBox({
            store: tcLeaseNameComboStore,
...
<!--        var gradeAndMineralsComboStore = new Ext.data.JsonStore({-->
<!--            url: '<%=request.getContextPath()%>/TripSheetGenerationAction.do?param=getGradeAndMineralsList',-->
<!--            id: 'gradeAndMineralsStoreId',-->
<!--            root: 'gradeAndMineralsRoot',-->
<!--            autoload: false,-->
<!--            remoteSort: true,-->
<!--            fields: ['gradeMineralsID', 'gradeMineralsName'],-->
<!--            listeners: {-->
<!--                load: function() {}-->
<!--            }-->
<!--        });-->
...
<!--            store: gradeAndMineralsComboStore,-->
...
<!--            triggerAction: 'all',-->
<!--            lazyRender: true,-->
<!--            valueField: 'gradeMineralsID',-->
<!--            displayField: 'gradeMineralsName',-->
<!--            cls: 'selectstylePerfect',-->
<!--            listeners: {-->
<!--                select: {-->
<!--                    fn: function() {-->
...
<!--        });-->
        ...
        var permitNoComboStore = new Ext.data.JsonStore({
            ...
            autoload: false,
            remoteSort: true,
            fields: ['routeId','routeName','quantity','permitNo','pId','tripSheetQty','grade','tcId','orgCode','leaseName','orgName'],
            listeners: {
                load: function() {}
            }
        });
        ...
        var vehicleComboStore = new Ext.data.JsonStore({
            ...
            autoload: false,
            remoteSort: true,
            fields: ['vehicleNoID', 'vehicleName', 'quantity1']
        });
       ...
       var tripStore = new Ext.data.JsonStore({
        ...
        grid = getGrid('<%=MiningTripSheetGeneration%>', '<%=noRecordsFound%>', store, screen.width - 55, 420, 20, filters, 'Clear Filter Data', false, '', 20, false, '', false, '', true, 'Excel', jspName, exportDataType, false, 'PDF', true, 'Add', false, 'Modify', false, '', false, '', false, 'Destination Weight', false, 'Close Trip',false,'',false,'',true,'Import Excel');
        ...
        var detailsSecondPanel = new Ext.Panel({
            ...
            items: [{
                ...
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryTcleaseNameId55'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryTcleaseNameId45'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryTcleaseNameId177'
            }, {
                xtype: 'label',
                text: '*',
                cls: 'mandatoryfield',
                ...
                text: ' ',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeId776'
            }, {
                xtype: 'label',
                text: ' ',
                cls: 'labelstyle',
                id: 'gradeAndMineralsID876'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeInforId855'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeInforId342'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeInforId098'
            }, {
                xtype: 'label',
                text: '*',
                cls: 'mandatoryfield',
                ...
                text: ' ',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeId776s'
            }, {
                xtype: 'label',
                text: ' ',
                cls: 'labelstyle',
                id: 'gradeAndMineralsID876s'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeInforId855s'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                id: 'mandatoryGradeInforId342s'
            }, {
                xtype: 'label',
                text: '',
                cls: 'mandatoryfield',
                ...
                listeners: {
                    click: {
                        fn: function() {
                            ...
                            if (orgCode != orgId) {
                                Ext.example.msg("Select different Permit");
                                return;
                            }
                            ...
                            Ext.Ajax.request({
                                ...
                                params: {
									...
									tripSheetType: 'Train Trip Sheet',
									bargeNo: bargeNo,
                                ...
                                success: function(response, options) {
                                    ...
                                    if(message=="0"){
                                       ...
                                       Ext.example.msg(message);
                                        ...
                                        message="Permit Balance is over or trip exists for vehicle. Please check.";
                                        Ext.example.msg(message);
                                    }else if(message>0){
                                        window.open("<%=request.getContextPath()%>/tripSheetPdf?systemId=" + <%=systemId%> + "&clientId=" + '<%=clientId%>' + "&clientName=" + '<%=custName%>' + "&vehicleNo=" + VehicleNoBaseType + "&buttonValue=" + buttonValue + "&uniqueId=" + message);
          ...
          BargeQuantityStore.load({
            ...
            d.setMinutes(00);
             ...
             if(bargeStatus=='Closed-Completed Trip'){
          	  Ext.example.msg("Train trip sheet is closed");
              return;             
             }
...
var buttonPanel=new Ext.FormPanel({
           ...
           buttons:[{
              		...
              		hidden:false,
              		handler : function(){
								var bargeTrip='/Telematics4uApp/Jsps/IronMining/TripSheetGenerationForTrainFirstTab.jsp?back='+back+'&startDate='+startDate+'&endDate='+endDate+'&custId='+clientId+'&custName='+custName;
