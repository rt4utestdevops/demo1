   ...
   <jsp:include page="../Common/MenuTabJS.jsp"/>
	...
	<script >
		...
		Ext.onReady(function(){
		    ...
		    function addTab(){
		        tripSheetTab.add({
		        title: 'Train Trip Sheet',
		       	iconCls: 'admintab',
		       	id:'generalBargeTab',
		       	html : "<iframe style='width:100%;height:524px;border:0;'src='<%=path%>/Jsps/IronMining/TripSheetGenerationForTrainFirstTab.jsp'></iframe>"
		        }).show();  
		        ...
		        title: 'Truck Trip Sheet',
		       	iconCls: 'admintab',
		       	id:'partOneTab',
		       	html : "<iframe style='width:100%;height:524px;border:0;'src='<%=path%>/Jsps/IronMining/TripSheetGenerationForTrain.jsp'></iframe>"
		        }).disable(); 
