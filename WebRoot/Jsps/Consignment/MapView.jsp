...
.mp-container1 {
	...
	<body oncontextmenu="return false">
				...
				<div class="mp-vehicle-details-wrapper" id="vehicle-details">
					<form class="me-select">
						<ul id="me-select-list">
							...
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Shipping Date</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="Shipping-Date-id"></span>
							</li>
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Schedule Delivery Date</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="Schedule-Delivery-Date-id"></span>
							</li>
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Revised Delivery Date</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="Revised-Delivery-Date-id"></span>
							</li>
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Status</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="status-id"></span>
							</li>
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Distance Covered(Kms)</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="Distance-Covered-id"></span>
							</li>
							<li class="me-select-label">
								<span class="vehicle-details-block-header">Remaining Distance(Kms)</span><span
									class="vehicle-details-block-sep">:</span><span
									class="vehicle-details-block" id="Remainin-Distance-id"></span>
							</li>
		...
		var allDetailsStore = new Ext.data.JsonStore({
		    url: '<%=request.getContextPath()%>/MapView.do?param=getConsignmentDetails',
		    id: 'allDetailsStoreId',
		    root: 'DetailsStoreRoot',
		    autoLoad: false,
		    fields: ['regNo', 'location', 'dateTime', 'speed', 'ignition', 'latitude', 'longtitude', 'category', 'ConsignmentNo','status','ShippingDate','ScheduleDeliveryDate','RevisedDeliveryDate','DistanceCovered','RemainingDistance']
		});
		...
		var editInfo1 = new Ext.Button({
		    ...
		    handler: function() {
		        ...
		        if (Ext.getCmp('ConsignmentNumberTextId').getValue() == "") {
		          
		                Ext.example.msg('Enter Consignment Number');
		               return;
		        }
		        allDetailsStore.load({
		            params: {
		                conNo: Ext.getCmp('ConsignmentNumberTextId').getValue()
		            },
		            callback: function() {
		                ...
		                document.getElementById('status-id').innerHTML = rec.data['status'];
		                document.getElementById('Shipping-Date-id').innerHTML = rec.data['ShippingDate'];
		                document.getElementById('Schedule-Delivery-Date-id').innerHTML = rec.data['ScheduleDeliveryDate'];
		                document.getElementById('Revised-Delivery-Date-id').innerHTML = rec.data['RevisedDeliveryDate'];
		                document.getElementById('Distance-Covered-id').innerHTML = rec.data['DistanceCovered'];
		                document.getElementById('Remainin-Distance-id').innerHTML = rec.data['RemainingDistance'];
		...
		var outerPanel = new Ext.Panel({
		    ...
		    items: [{
		            ...
		            id: 'ConsignmentNumberTextId',
		            emptyText: 'Enter Consignment Number'
		        }, {
		            width: 70
		        },
		        editInfo1
