  		      ...
  		      if (dateCompare(Ext.getCmp('enddate').getValue(), datenextt)== -1) {
                  ...
                  return;
				    ...
				    custId = Ext.getCmp('custcomboId').getValue();
				     ...
				     if(<%=custExist%>)
				      {
				       window.open("<%=request.getContextPath()%>/HistoricalTripReport?startDate="+startDate+"&endDate="+endDate+"&clientId="+Ext.getCmp('custcomboId').getValue());
				      }
				      else{
                     window.open("<%=request.getContextPath()%>/ActionLogDetailsReport?startDate="+startDate+"&endDate="+endDate+"&clientId="+Ext.getCmp('custcomboId').getValue());
                      }        
       			}
       			}
       			}
