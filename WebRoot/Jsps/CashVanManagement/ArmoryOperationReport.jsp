...
<html>
	<head>
		<title>Armory Operation Report</title>		
	</head>	    
   ...
   <jsp:include page="../Common/ImportJS.jsp" /><%} %>
   	...
   	<script>
   	var jspName = "Armory Operation Report";
  	var exportDataType = "int,date,string,string,string,string,string,string";
    var outerPanel;
    var ctsb;
    var summaryGrid;
    var custId;
  ...
  var VehicleComboStore = new Ext.data.JsonStore({
   ...
   var innerPanel = new Ext.Panel({
    ...
    var reader = new Ext.data.JsonReader({
        idProperty: 'readerId',
        root: 'ArmoryOperationSummaryRoot',
        totalProperty: 'total',
        fields: [{
            name: 'slnoIndex'
        },{
            ...
            name: 'assetNameDataIndex'
        },{
        	name: 'locationOfDataIndex'
        }]
    });
    ...
    var SummaryReportStore = new Ext.data.GroupingStore({
        ...
        proxy: new Ext.data.HttpProxy({
            url: '<%=request.getContextPath()%>/CashVanReportAction.do?param=getArmoryOperationReport',
            method: 'POST'
        }),
        remoteSort: false,
        storeId: 'ArmorysummaryStoreId',
        reader: reader
    });
    ...
    var filters = new Ext.ux.grid.GridFilters({
        ...
        filters: [{
            ...
            type: 'string',
            dataIndex: 'assetNameDataIndex'
        },{
        	type: 'string',
            dataIndex: 'locationOfDataIndex'
        }]
    });
    ...
    var createColModel = function (finish, start) {
        ...
        var columns = [
            new Ext.grid.RowNumberer({
                ...
                header: "<span style=font-weight:bold;>Location Of Asset</span>",
                dataIndex: 'locationOfDataIndex',
                filter: {
                    type: 'string'
                }
