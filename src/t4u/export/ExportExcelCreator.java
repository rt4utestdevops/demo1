 ...
 */
public class ExportExcelCreator 
{
	...
	WritableCellFormat threeDigitsAfterPt = new WritableCellFormat(dataWF,new NumberFormat("#,##0.000"));
	WritableCellFormat sixDigitsAfterPt = new WritableCellFormat(dataWF,new NumberFormat("#,##0.000000"));
		...
		try
		{
		    ...
		    for(int i = 0; i < size; i ++)
		    {
		    	...
		    	else if(type.equals("number3"))
		    	{
		    		...
		    		sheet.addCell(new jxl.write.Number(col,row,data,threeDigitsAfterPt));
		    		
		    	}
		    	else if(type.equals("number6"))
		    	{
		    		...
		    		sheet.addCell(new jxl.write.Number(col,row,data,sixDigitsAfterPt));
