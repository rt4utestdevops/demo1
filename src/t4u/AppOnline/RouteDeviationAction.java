...
public class RouteDeviationAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (param.equalsIgnoreCase("getRouteDeviationReport")) {
			...
			try {
				...
				ArrayList<Object> routeDeviationDetails = func.getRouteDeviationDetails(clientId,startDate,endDate);
				jsonArray = (JSONArray) routeDeviationDetails.get(0);
				...
				ReportHelper reportHelper = (ReportHelper) routeDeviationDetails.get(1);
