...
public class LogisticsDailyStatusReportActionNew extends HttpServlet {
	int systemId=0;
	String clientId="";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		    ...
		    reportdataList=alf.getActionLogDetailsNew(clientId,systemId,startDate,endDate,offset);
