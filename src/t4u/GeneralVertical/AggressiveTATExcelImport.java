...
public class AggressiveTATExcelImport {
	...
	private String saveExcelDataToDB(List<AggressiveTATData> supervisordataListAll, int systemId, int clientId, int userId) {
		String message = "No data to upload";
		Connection con = null;
		try {
			con = DBConnection.getConnectionToDB("AMS");
			for (@SuppressWarnings("unused")
			AggressiveTATData supervisordataDetails : supervisordataListAll) {
