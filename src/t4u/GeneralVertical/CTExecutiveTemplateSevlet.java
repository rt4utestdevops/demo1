...
public class CTExecutiveTemplateSevlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String responseFromAjax =  properties.getProperty("DownloadTemplateForRegion").trim();//request.getParameter("relativePath");
