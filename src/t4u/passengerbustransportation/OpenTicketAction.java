...
public class OpenTicketAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		if(param.equalsIgnoreCase("getOpenTripInfoRound")){
				...
				String phoneNo=null;
					...
					passangerCancelTripInfo=ptf.partailCanelationWithMultipleSelectedForOpenTrip(transactionID,email,phoneNo,tripType,onwordSeats,returnSeats,
			...
			}else if(param.equalsIgnoreCase("getOpenTripInfoSingle")){
				String transactionID=null;
				String onwordSeats=null;
				String email=null;
				String phoneNo=null;
				...
				try{
					...
					passangerCancelTripInfo=ptf.partailOpenTripWithMultipleSelectedForSingle(transactionID, email, phoneNo, onwordSeats,
